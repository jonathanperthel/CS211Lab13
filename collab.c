...
void jperth2_amuno5() {
    printf("Jonathan Perthel and Andrea Munoz\n");
    printf("We learned that git is a tool and github is where repositories are stored\n");
    printf("We had difficulty using replit, and instead used CLion\n");
}
